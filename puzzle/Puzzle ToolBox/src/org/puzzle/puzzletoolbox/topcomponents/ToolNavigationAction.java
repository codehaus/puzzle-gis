...
/**
 * Action which shows ToolNavigation component.
 * @author johann sorel
 */
public class ToolNavigationAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent evt) {
        TopComponent win = ToolNavigationTopComponent.findInstance();
        win.open();
        win.requestActive();
    }
}
