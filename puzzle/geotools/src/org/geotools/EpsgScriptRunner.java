...
final class EpsgScriptRunner extends ScriptRunner {
     ...
     */
    public static void createDerby(String url, String folder,String user, String password) throws FactoryException {
        
        final boolean isJavadb = true;
        if (isJavadb) {
            url += ";create=true";
        }
        Exception failure;
