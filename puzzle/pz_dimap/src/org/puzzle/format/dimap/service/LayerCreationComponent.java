...
public class LayerCreationComponent extends JLayerChooser {
    ...
    private final DimapSource source;

    /** Creates new form LayerCreationComponent */
    LayerCreationComponent(LayerChooserMonitor monitor, DimapSource source, String name) {
        super(monitor);
        this.source = source;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText(DimapResource.getString("title")); // NOI18N
