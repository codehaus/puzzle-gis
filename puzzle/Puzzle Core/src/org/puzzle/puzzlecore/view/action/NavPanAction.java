 ...
 * @author johann sorel
 */
public final class NavPanAction extends CallableSystemAction implements ViewListener{
...
//        }
    ...
    public String getName() {
        return NbBundle.getMessage(NavPanAction.class, "CTL_PanMapAction");
    }

    @Override
    protected String iconResource() {
        return "org/puzzle/puzzlecore/view/resource/mouse.png";
    }
