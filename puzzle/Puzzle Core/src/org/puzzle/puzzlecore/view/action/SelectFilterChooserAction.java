...
import org.geotools.gui.swing.map.map2d.stream.control.SelectFilterChooser;
 ...
 * @author johann sorel
 */
public final class SelectFilterChooserAction extends CallableSystemAction {

    private SelectFilterChooser action = new SelectFilterChooser();
    
    public SelectFilterChooserAction() {                
...
//        }
    ...
    public String getName() {
        return NbBundle.getMessage(SelectFilterChooserAction.class, "CTL_ChooseLayerMapAction");
    }
