 ...
 * @author johann sorel
 */
public class ClipTool extends JPanel {
    ...
    private String error = NbBundle.getMessage(ClipTool.class, "error");

    /** 
     * Creates new form ClippingTool 
     * @param parameters 
     */
    public ClipTool(Map parameters) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jXTitledSeparator1.setTitle(org.openide.util.NbBundle.getMessage(ClipTool.class, "clip")); // NOI18N

        jLabel1.setText(org.openide.util.NbBundle.getMessage(ClipTool.class, "input_layer")); // NOI18N

        gui_jcb_inlayer.setModel(inModel);

        gui_but_infile.setText(org.openide.util.NbBundle.getMessage(ClipTool.class, "...")); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(ClipTool.class, "clip_geom")); // NOI18N

        gui_jcb_cliplayer.setModel(clipModel);

        gui_but_clipfile.setText(org.openide.util.NbBundle.getMessage(ClipTool.class, "...")); // NOI18N
        ...
        jLabel3.setText(org.openide.util.NbBundle.getMessage(ClipTool.class, "output_layer")); // NOI18N

        gui_jtf_outfile.setEditable(false);

        gui_but_outfile.setText(org.openide.util.NbBundle.getMessage(ClipTool.class, "...")); // NOI18N
        ...
        gui_ok.setText(org.openide.util.NbBundle.getMessage(ClipTool.class, "ok")); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jXTitledSeparator1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 513, Short.MAX_VALUE)
                    .add(layout.createSequentialGroup()
                        .add(jLabel1)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(gui_jcb_inlayer, 0, 449, Short.MAX_VALUE))
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                        .add(gui_progress, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 460, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(gui_ok))
                    .add(layout.createSequentialGroup()
                        .add(gui_jtf_inexternal, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 462, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(gui_but_infile))
                    .add(layout.createSequentialGroup()
                        .add(jLabel2)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(gui_jcb_cliplayer, 0, 409, Short.MAX_VALUE))
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                        .add(gui_jtf_clipexternal, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 462, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(gui_but_clipfile))
                    .add(jLabel3)
                    .add(layout.createSequentialGroup()
                        .add(gui_jtf_outfile, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 462, Short.MAX_VALUE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(gui_but_outfile)))
                .addContainerGap())
        );
