...
public class LayerCreationComponent extends JLayerChooser {
    ...
    private final CoverageFileSource source;

    /** Creates new form LayerCreationComponent */
    LayerCreationComponent(LayerChooserMonitor monitor, CoverageFileSource source, String name) {
        super(monitor);
        this.source = source;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText(CFResource.getString("title")); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(guiTitle, GroupLayout.DEFAULT_SIZE, 332, Short.MAX_VALUE)
                .addContainerGap())
        );
