 ...
 * @author johann sorel
 */
public class PostGISToolDescriptor1 extends AbstractToolDescriptor {
    ...
    private final String title = ResourceBundle.getBundle("org/puzzle/shell/gdal/database/postgis/Bundle").getString("title");
    ...
    public Component getComponent() {
        return new GDALProcessWidgetTool(new PostGISTool1());
    }
