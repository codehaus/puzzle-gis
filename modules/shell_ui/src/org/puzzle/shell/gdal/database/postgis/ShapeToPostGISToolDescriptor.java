 ...
 * @author johann sorel
 */
public class ShapeToPostGISToolDescriptor extends AbstractToolDescriptor{
    
    private final String title = NbBundle.getMessage( ShapeToPostGISToolDescriptor.class,"title2");
    ...
    public Component getComponent() {
        return new GDALProcessWidgetTool(new ShapeToPostGISTool());
    }
