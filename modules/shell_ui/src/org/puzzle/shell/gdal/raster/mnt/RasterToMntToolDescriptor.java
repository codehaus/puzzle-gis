 ...
 * @author johann sorel
 */
public class RasterToMntToolDescriptor extends AbstractToolDescriptor {
    
    private final String title = NbBundle.getMessage(RasterToMntToolDescriptor.class, "rastertomnt");
    ...
    public Component getComponent() {
        return new GDALProcessWidgetTool(new RasterToMntTool());
    }
