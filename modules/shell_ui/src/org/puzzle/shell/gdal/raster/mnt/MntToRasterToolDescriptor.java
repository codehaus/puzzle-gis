 ...
 * @author johann sorel
 */
public class MntToRasterToolDescriptor extends AbstractToolDescriptor {
    
    private final String title = NbBundle.getMessage(RasterToMntToolDescriptor.class, "mnttoraster");
    ...
    public Component getComponent() {
        return new GDALProcessWidgetTool(new MntToRasterTool());
    }
