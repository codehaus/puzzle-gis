 ...
 * @author johann sorel
 */
public class FolderRasterConvertToolDescriptor extends AbstractToolDescriptor {

    private final String title = NbBundle.getMessage(FolderRasterConvertToolDescriptor.class,"title");
    ...
    public Component getComponent() {
        return new GDALProcessWidgetTool(new FolderRasterConvertTool());
    }
