 ...
 * @author johann sorel
 */
public class OneFileVectorConvertToolDescriptor extends AbstractToolDescriptor {
    ...
    private final String title = ResourceBundle.getBundle("org/puzzle/shell/gdal/vector/onefile/Bundle").getString("title");
    ...
    public Component getComponent() {
        return new GDALProcessWidgetTool(new OneFileVectorConvertTool());
    }
