 ...
 * @author johann sorel
 */
public class OneFileRasterConvertToolDescriptor extends AbstractToolDescriptor {
    
    private final String title = NbBundle.getMessage(OneFileRasterConvertToolDescriptor.class, "title");
    ...
    public Component getComponent() {
        return new GDALProcessWidgetTool(new OneFileRasterConvertTool());
    }
