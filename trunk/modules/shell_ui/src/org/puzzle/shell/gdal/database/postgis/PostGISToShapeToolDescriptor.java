 ...
 * @author johann sorel
 */
public class PostGISToShapeToolDescriptor extends AbstractToolDescriptor {
    
    private final String title = NbBundle.getMessage( PostGISToShapeToolDescriptor.class,"title");
    ...
    public Component getComponent() {
        return new GDALProcessWidgetTool(new PostGISToShapeTool());
    }
