 ...
 * @author johann sorel
 */
public class FolderVectorConvertToolDescriptor extends AbstractToolDescriptor {

    private final String title = NbBundle.getMessage(FolderVectorConvertToolDescriptor.class,"title");
    ...
    public Component getComponent() {
        return new GDALProcessWidgetTool(new FolderVectorConvertTool());
    }
