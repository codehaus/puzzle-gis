 ...
 * @author johann sorel
 */
public class ClipToolDescriptor extends AbstractToolDescriptor{

   
    private final String[] path = ToolTreeConstants.getInstance().ANALYSE_GEOMETRIE.getPath();
    
    private String title =  NbBundle.getMessage(ClipToolDescriptor.class, "clip");
    ...
    public Component getComponent() {
        return new ClipTool(new HashMap());
    }
