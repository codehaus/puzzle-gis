...
class LayerCreationWizardPanel implements WizardDescriptor.Panel {
    ...
    LayerCreationWizardPanel(Collection<? extends MapContext> contexts, GISProject project, DataStore store){
    ...
    public Component getComponent() {
        if (component == null) {
            component = new LayerCreationVisualPanel(contexts,store);
        }
        return component;
    }
