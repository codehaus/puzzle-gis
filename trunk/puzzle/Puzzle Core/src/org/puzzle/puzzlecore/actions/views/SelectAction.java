 ...
 * @author johann sorel
 */
public final class SelectAction extends CallableSystemAction implements ViewListener {
    ...
    public String getName() {
        return NbBundle.getMessage(SelectAction.class, "CTL_SelectMapAction");
    }

    @Override
    protected String iconResource() {
        return "org/puzzle/puzzlecore/actions/views/select.png";
    }
