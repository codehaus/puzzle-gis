...
import org.geotools.gui.swing.map.map2d.control.NextAreaAction;
 ...
 * @author johann sorel
 */
public final class NavNextAreaAction extends CallableSystemAction implements ViewListener{

    private NextAreaAction action = new NextAreaAction();
    ...
    protected String iconResource() {
        return "org/puzzle/puzzlecore/actions/views/next.png";
    }
