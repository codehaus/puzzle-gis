 ...
 * @author johann sorel
 */
public final class SelectHandlerChooserAction extends CallableSystemAction implements ViewListener{

    private SelectHandlerChooser action = new SelectHandlerChooser();
    
    public SelectHandlerChooserAction() {                
